...
import 'package:you_can/view/pages/home/sessions/sessionsScreen/inside_screens/sessionVideo/Questions.dart';
import 'package:you_can/view/pages/home/sessions/sessionsScreen/inside_screens/sessionVideo/students.dart';

import '../../../../../../../core/localization/check_local.dart';

class SessionVideoScreen extends StatefulWidget {
  const SessionVideoScreen({super.key});
                  ...
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: TabBar(
                        ...
                        tabs: [
                          Center(child: Text('Questions',style: TextStyle(fontWeight: FontWeight.w600,fontSize: 16.sp),)),
                          Center(child: Text('Comments',style: TextStyle(fontWeight: FontWeight.w600,fontSize: 16.sp),)),
                          Center(child: Text("Students",style: TextStyle(fontWeight: FontWeight.w600,fontSize: 16.sp),)),
